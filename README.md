...
**Evaluation Metrics:** 
We assessed the performance of our regression models using at least two relevant evaluation metrics, such as Root Mean Squared Error (RMSE) and Mean Absolute Error (MAE).

**Model Comparison:** 
We compared the results for different regression models like Linear Regression, Polynomial Regression, XGBoost Regressor and Random Forest Regressor, and provided the reasoning behind our choices.
